...
#pragma HLS resource variable=addrlut core=ROM_1P_1S
	...
	Executereg.isopcodeBranchorJump =  Decodereg.isopcodeBranchorJump;
	Executereg.rs1 = Decodereg.rs1 ;
	Executereg.rs2 = Decodereg.rs2 ;
	Executereg.nextPCDC = Decodereg.nextPCDC ;
...
#pragma HLS inline
	...
	Memoryreg.isopcodeBranchorJump =  Executereg.isopcodeBranchorJump;
	Memoryreg.rs1 = Executereg.rs1 ;
	Memoryreg.rs2 = Executereg.rs2 ;
	Memoryreg.nextPCDC = Executereg.nextPCDC ;
